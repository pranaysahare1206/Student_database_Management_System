...
Label(main, text="STUDENT MANAGEMENT SYSTEM", font=headlabelfont, bg='SpringGreen2').pack(side=TOP, fill=X)
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='coral', fg='LightCyan').pack(side=TOP, fill=X)
